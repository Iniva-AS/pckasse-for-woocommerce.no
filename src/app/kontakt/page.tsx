          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 ring-1 ring-indigo-100 lg:w-1/2">
              ...
              >
                ...
                <rect width="100%" height="100%" strokeWidth="0" className="fill-blue-50" />
                <svg x="100%" y="-1" className="overflow-visible fill-indigo-100">
            ...
            <h2 className="text-pretty text-4xl font-bold tracking-tight text-gray-950 sm:text-5xl">
              Kontakt oss
            </h2>
            <p className="mt-6 text-lg/8 text-gray-700">
              Har du spørsmål om PCKasse for WooCommerce? Vi hjelper deg gjerne med å komme i gang eller svarer på spørsmål om tjenesten.
            </p>
            <dl className="mt-10 space-y-4 text-base/7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="tel:+4712345678" className="hover:text-gray-900">
                    +47 123 45 678
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:kontakt@pckasse-for-woocommerce.no" className="hover:text-gray-900">
                    kontakt@pckasse-for-woocommerce.no
                  </a>
                </dd>
              </div>
            </dl>
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:-outline-offset-2 focus:outline-2 focus:outline-indigo-600"
                  />
                </div>
              </div>
              <div>
